...
namespace DevHorizons.DAL.Abstracts
{
    ...
    public abstract class ACommand : ICommand
    {
        ...
        /// <inheritdoc/>
        public bool ChangeConnectionString(string connectionString, bool updateConnectionString = false)
        {
            ...
            return this.ResetHard(updateConnectionString);
        }
        ...
        /// <inheritdoc/>
        public bool ResetHard(bool updateConnectionString)
        {
            this.Reset();
        ...
        {
            this.Settings.ConnectionSettings.UpdateConnectionString();
        }
        #region IDisposable Support
        ...
        /// </Created>
        private bool InitializeConnection(bool updateConnectionString)
        {
            ILogDetails error = null;
