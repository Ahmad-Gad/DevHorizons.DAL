...
(
	[UserId] Int Not Null Identity(1, 1) Constraint [PK_Discount] Primary Key,
	[StockID] nVarChar(Max) Not Null,
	[Title] nVarChar(250),
	[StartDate] DateTime2(0) Not Null,
	[ExpiryDate] DateTime2(0) Not Null,
	[Details] nVarChar(Max) Not Null,
	[Active] Bit Not Null Constraint [DF_Discount_Active] Default(0), -- Inactive by default. Needs review/process for manual/auotmatic activation.
...
/*
	...
	[Details]
	{
		[
			...
			"MaxPerUser" : 0, /* No maximum limit for the same user */
			"ExemptedUsers" : {},
			"ExemptedCountries" : {},
			"ExemptedStates" : {},
			"ExemptedCities" : {},
